...
class Tests {
    ...
    fun containsIn() {
        ...
        assertTrue(containsIn(mapOf("a" to "z", "b43-sdf-=" to "afdasdfasdfsadfasdfasdf"), mapOf("b43-sdf-=" to "afdasdfasdfsadfasdfasdf", "b" to "sweet")))
    }
    ...
    fun whoAreInBoth() {
        ...
        assertEquals(
            listOf(""),
            whoAreInBoth(listOf("", "Mikhail"), listOf(""))
        )
    }
